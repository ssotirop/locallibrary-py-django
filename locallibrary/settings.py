...
#SECRET_KEY = 'ge5*5f$af+v-ly6qbxa-m=)3*e4q1b_6z8wf&i=apfh1o7fme-'
import os
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'ge5*5f$af+v-ly6qbxa-m=)3*e4q1b_6z8wf&i=apfh1o7fme-')
...
# OPTIONAL: Reduce the size of the static files when they are served
